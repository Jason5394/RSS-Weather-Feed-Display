...
class LoadWindow(view.FormTopLevel):
    ...
    def __init__(self, root, controller=None, **kwargs):
        ...
        self.instruct_label = ttk.Label(self.frame1,
            text="Load a previously saved RSS feed.")
        ...
        vsb = ttk.Scrollbar(self.frame2, orient="vertical",
            command=self.tree.yview)
        hsb = ttk.Scrollbar(self.frame2, orient="horizontal",
        ...
        #add buttons
        self.load_button = ttk.Button(self.frame3, text="Load",
            width=10, command=self.__pressedLoad)
        self.delete_button = ttk.Button(self.frame3, text="Delete",
            width=10, command=self.__pressedDelete)
        self.cancel_button = ttk.Button(self.frame3, text="Cancel",
            width=10, command=self.__pressedCancel)
